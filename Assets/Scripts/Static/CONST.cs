...
public class CONST 
{
    ...
    public const int GEN_TURN_CHANCE = 40;     // %
    public const int GEN_TWIST_CHANCE = 15;    // %
    public const int GEN_MIN_WP_DISTANCE = 30; // meters
    public const int GEN_MAX_WP_DISTANCE = 90; // meters
    public const int GEN_WP_ANGLE_RND = 130;   // degrees
    public const int TEXTURE_TILE_FACTOR = 5;  // degrees
    public const int GLOBAL_NORMAL_ANGLE = 45; // degrees
